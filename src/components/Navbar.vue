<template>
    <header class="flex items-center h-14 py-4 shadow bg-white d-flex justify-between">
        <button @click="emit('toggle-sidebar')"   class="p-4 text-gray-700 hover:bg-black/10">
